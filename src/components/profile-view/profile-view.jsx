...
export class ProfileView extends React.Component {
  ...
  updateUser = (e) => {
    ...
    axios
      .put(
        `https://agile-dusk-10644.herokuapp.com/users/${Username}`,
        {
  ...
  removeUser() {
    ...
    const token = localStorage.getItem("token");
    axios
      .delete(`https://agile-dusk-10644.herokuapp.com/users/${Username}`, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then(() => {
      ...
      <Container>
        ...
        <Row>
          <Col id="fav-movie-card-col">
            <Card>
              <Card.Body>
                <Card.Title id="fav-movie-card-title">
                  Your Favorite Movies
                </Card.Title>
                {!FavoriteMovies ||
                  (FavoriteMovies.length === 0 && (
                    <div>
                      You haven't added any movies to your favorites list
                    </div>
                  ))}
                <Row>
                  {FavoriteMovies?.length > 0 &&
                          ...
                          >
                            ...
                            <Card.Body>
                              ...
                              <Button
                                value={movie._id}
                                onClick={(e) =>
                                  this.removeFromFavorite(e, movie)
                                }
                              >
